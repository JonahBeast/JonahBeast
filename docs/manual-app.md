# Manual de la app Jonah Beast Fuel

> **Para qué sirve este documento:** es la base de conocimiento del asistente de WhatsApp (y de cualquier ayuda dentro de la app). Explica cómo se usa la app, pantalla por pantalla, con los nombres exactos de botones y mensajes.
>
...
| Mensaje | Qué hacer |
|---|---|
| "Completa correo y contraseña." | Llenar ambos campos. |
| "Correo o contraseña incorrectos." | Revisar el correo o recuperar la contraseña. |
| "Aún no confirmaste tu correo. Revisa tu bandeja (y spam)." | Buscar el correo de confirmación y tocar el enlace. |
...
Si abrió un enlace de recuperación del correo: verá "CREA TU CONTRASEÑA NUEVA" → escribe la contraseña dos veces → **"Guardar contraseña"** → **"Entrar a mi cuenta"**.

Errores: "El código no es válido o ya venció. Pide uno nuevo." · "Las contraseñas no coinciden." · "No se pudo enviar el código. Intenta de nuevo en un momento."
...
## 8. Pestaña "Comidas" (registrar lo que comes)
...
**E) Atajos de cada comida (abajo en la hoja "REGISTRAR")**
- **"⚡ Agregar tu de siempre: …"** (si la comida está vacía).
- **"↩ Repetir ayer"** → "Agregar todo" (lo de ayer en esa misma comida).
- **"★ Mis comidas"** → "Agregar" (comidas que guardaste; el tacho las borra).
...
1. Toca la tarjeta 🚫, busca el alimento y tócalo → "🚫 No volveremos a sugerirte [alimento]".
2. Para quitarlo, toca la **X** junto al nombre.
- Solo evita que aparezca en sugerencias y reemplazos. **No es un control médico de alergias** y no impide registrarlo.
...
Arriba hay dos botones: **"Mis datos"** y **"Objetivo"**.
...
- "Mi amigo no ve el descuento" → se registró sin el código o lo escribió mal; el código no se puede agregar después desde la app → pasar a Jonah.
- Los cupones de la tienda son distintos del código de invitación.
...
- "Pagué y no se activó" → esperar unos minutos; si sigue igual, pedir el número de operación y pasar a Jonah.
...
## 14. Notificaciones (avisos de Jonah)
...
En Inicio, el aviso "Jonah está contigo…" tiene el botón **"Desactivar"**. También se puede quitar el permiso en los ajustes del navegador.

### 14.3 Instalar la app en el celular

- **Android (Chrome):** menú de tres puntos → "Instalar aplicación" o "Agregar a pantalla principal" → confirmar. (En la app también está el botón "Instalar app".)
...
## 16. Tienda (jonahbeast.com/tienda)

- Vende ropa, accesorios y suplementos (Evogen, Insane Labz, BluHealth Nutrition, Dragon Pharma, YoungLA).
- Categorías: "Lo nuevo", "Hombre", "Mujer", "Accesorios", "Suplementos".
