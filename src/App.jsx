...
const RAW_FOODS = [
  ...
  ["Platos preparados","Sandwich de pollo (PECAFIT)","-",292.27,6.04,33.30,15.79,0.0],
  ["Platos preparados","Sandwich de atún (PECAFIT)","-",387.39,18.45,31.42,21.17,0.0],
  ["Platos preparados","Omelette (PECAFIT)","-",142.73,10.61,9.20,7.34,0.0],
  ["Platos preparados","Bowl de avena (PECAFIT)","-",215.43,7.60,49.27,2.25,0.0],
  ["Platos preparados","Waffles de avena y plátano (PECAFIT)","-",335.33,15.30,76.47,5.30,0.0],
  ["Platos preparados","Waffles de beterraga (PECAFIT)","-",320.00,14.46,72.96,5.08,0.0],
  ["Platos preparados","Filete de pollo (PECAFIT)","-",195.83,11.59,32.43,2.92,0.0],
  ["Platos preparados","Quinua chaufa (PECAFIT)","-",269.00,15.63,28.60,11.46,0.0],
  ["Platos preparados","Bowl andino (PECAFIT)","-",237.29,14.95,30.75,7.41,0.0],
  ["Platos preparados","Bowl Super Power (PECAFIT)","-",181.00,16.03,19.30,3.92,0.0],
  ["Platos preparados","Filete de trucha (PECAFIT)","-",101.00,11.20,8.90,2.18,0.0],
  ["Platos preparados","Peca Power Meat (PECAFIT)","-",172.73,13.23,28.30,3.13,0.0],
  ["Platos preparados","Wrap proteico (PECAFIT)","-",153.57,19.55,4.46,6.16,0.0],
  ["Platos preparados","Wrap filete de pollo (PECAFIT)","-",107.31,16.88,1.68,3.38,0.0],
  ["Platos preparados","Wrap crocante (PECAFIT)","-",95.42,13.92,2.63,3.08,0.0],
  ["Platos preparados","Cake de plátano (PECAFIT)","-",515.00,16.81,61.22,28.79,0.0],
  ["Platos preparados","Torta de cacao (PECAFIT)","-",512.00,16.98,43.55,34.77,0.0],
];
...
const UNITS_BY_NAME = {
  ...
  'Waffles de beterraga (PECAFIT)': [['porción', 320]],
  ...
  'Filete de trucha (PECAFIT)': [['plato', 400]],
  'Peca Power Meat (PECAFIT)': [['plato', 550]],
