...
- Bono por suscribirse a tiempo: el primer plan pagado de alguien en prueba gratis, enviado antes de que termine su prueba o hasta 48 horas después, recibe +7 días gratis que se suman solos al aprobarse el pago (con Yape/Plin/transferencia cuenta cuándo envió el comprobante; al aprobar un pago así el panel lo avisa y el pago queda con la nota "Incluye +7 días de regalo"). Desde el día 13 de la prueba el alumno ve un reloj con la cuenta regresiva. Las renovaciones no lo repiten
